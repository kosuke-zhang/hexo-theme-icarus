...
class Toc extends Component {
    ...
    renderToc(toc) {
        ...
        let right = <i class="fa fa-chevron-right" onclick="showToc(this)"></i>
        let down = <i class="fa fa-chevron-down" onclick="hiddenToc(this)"></i>
        let hidden = true

        if (!toc.hasOwnProperty('1')) {
            hidden = false
            right = ''
            down = ''
        }
    ...
    render() {
        ...
        const js = `
        function showToc(obj) {
            obj.parentNode.parentNode.setAttribute('class', 'hidden');
            obj.parentNode.parentNode.nextElementSibling.setAttribute('class', '');
        }
        function hiddenToc(obj) {
            obj.parentNode.parentNode.setAttribute('class', 'hidden');
            obj.parentNode.parentNode.previousElementSibling.setAttribute('class', '');
        }
        ...
        return <div class="card widget" id="toc" style="max-height: 100vh;overflow: auto;">
